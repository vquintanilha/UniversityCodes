...
namespace GerenciamentoDeFuncionarios.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Nascimento,Lotacao")] Funcionario funcionario)
        {
            ...
            ViewData["Lotacao"] = new SelectList(_context.Departamento, "Id", "Nome", funcionario.LotacaoId);
            return View(funcionario);
        }
